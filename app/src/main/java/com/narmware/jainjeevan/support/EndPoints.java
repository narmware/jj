...
public class EndPoints {
    ...
    public static final String SERVER_URL="http://jainjeevan.com/api/";
    public static final String GET_BHOJANALAY=SERVER_URL+"get_bhojanalaya.php";
    public static final String GET_DHARAMSHALA=SERVER_URL+"get-dharmshala-page.php";
    public static final String GET_DATA=SERVER_URL+"data.php";
    public static final String GET_BHOJANALAY_DATA=SERVER_URL+"get_bhojanalay_data.php";
    ...
    public static final String CHECK_EXISIING_USER=SERVER_URL+"existing_user.php";
