...
import com.narmware.jainjeevan.adapter.BhojanalayaAdapter;
...
public class BhojanalayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context=BhojanalayActivity.this;
...
/*
    ...
    public void setDharamshalaAdapter() {
        ...
        dharamshalaAdapter = new BhojanalayaAdapter(BhojanalayActivity.this, dharamshalaItems,getSupportFragmentManager());
        final LinearLayoutManager linearLayoutManager=new LinearLayoutManager(BhojanalayActivity.this);
